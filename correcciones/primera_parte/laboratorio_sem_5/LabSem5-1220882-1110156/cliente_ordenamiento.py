...
def parse_args():
    ...
    parser.add_argument("-p", "--prueba",  metavar="NT",  type=int, default=1,
                    help="number of tries for each set of elements")
    ...
    if args.prueba <= 0 or args.prueba > 3:
        print("Error, el numero de pruebas debe ser mayor que cero\n")
        parser.print_help()
        sys.exit(1)
...
#intentamos hacer la llamada para las pruebas 2 y 3  con el respectivo comando
# ./cliente_ordenamiento.py -g -p 2 -t 3 1000 2000 4000 5000 y
# ./cliente_ordenamiento.py -g -p 3 -t 3 1000 2000 4000 5000 respectivamente
#sin embargo las prubas generan un error por excederse el numero de iteraciones posibles ya que
# el algoritmo quicksort debe agarrar el pivote n veces en cada iteraccion y "explota" la memoria
#de la computadora.
# de cada prueba resultaron las imagenes Lab4_p1.npg, Lab4_p2.npg,Lab4_p3.npg de las cuales podemos
#concluir que el quicksort basico es el mas eficiente para arreglos de numeros aleatorios
# hasta de poco mas de 3000 numeros y mergesort es eficiente para arreglos mas grandes
#en cambio en el caso de ceros y unos, y laprueba 2 representan el peor caso para quicksort
#por lo cual resulta ser menos eficiente incluso para entradas muy peque#as
