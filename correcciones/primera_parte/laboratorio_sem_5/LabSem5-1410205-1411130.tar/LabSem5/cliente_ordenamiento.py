...
def parse_args():
    ...
    parser.add_argument("-p","--prueba",type=int,default=1,help="1:Array with random elements. 2:Array with descending elements. 3:Array with random zeros and ones")
...
def obtener_arreglo_descendente(n):
    """
    Crea arreglo con n elementos en orden descendente.
