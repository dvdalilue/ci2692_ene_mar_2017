...
def parse_args():
    ...
    if args.ntry <= 0:
        ...
        parser.print_help()
        sys.exit(1)
    if not (0 < args.prueba < 4):
        print("El numero de prueba debe estar entre 1 y 3")
        parser.print_help()
        sys.exit(1)
...
"""
EXPLICACION
El limite de recursion de python3 es de 1000. Esto lo determinamos ejecutando el 
comando sys.getrecursionlimit() por lo tanto la llamada -p solo funcionara para los
ejercicios 2 y 3 con un maximo de 990 elementos aproximadamente"
"""
