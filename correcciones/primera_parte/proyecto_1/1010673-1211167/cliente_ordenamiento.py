...
# Edicion: 10-10673 Jorge Sanchez
...
def cargar_algoritmos_de_modulos():
    ...
    """
    lista = ['Mergesort', 'heap_sort','quicksort_aleatorio','median_of_3_Quicksort','Introsort','Quicksort_3_way_partitioning','Dual_pivot_quicksort']
    functions_list = [o for o in inspect.getmembers(ordenamiento)
                      if inspect.isfunction(o[1]) and o[0] in lista]
    ...
    #opcion 1
        if prueba == 1:
            ...
            for n in n_elems:
                ...
                i += 1
    #opcion 4    
        elif prueba == 4:   # Arreglo ordenado de 1 a len(A)
            i = 0
            for n in n_elems:
                arrg = arr_ordenado(n)
                j = 0
