""" Algoritmos II .ene-mar 2017 
	fecha: 11/03/2017
    Descripcion:  TAD que representa un lista de reproduccion que se encontrara en el archivo lista.py. Esencialmente
se debe implementar una lista circular doblemente enlazada
	autores: Edymar Mijares 12-10882
	         Jose Carmona 11-10156

	correo: - edys.beccaria@gmail.com
		   - carmona621@hotmail.com
ultima edicion :17/03/2017"""
...
class Reproductor(QWidget):
    ...
    def eliminar(self, title):
        self.__playlist.elimi_can(title)
