...
class Reproductor(QWidget):
    ...
    def play(self):    
        ...
        if self.playlist.proximo == None:
            return

        file = self.playlist.proximo.elemento.archivo
        ...
        self.playlist.proximo = self.playlist.proximo.siguiente
    ...
    def prev(self):
        ...
        self.playlist.proximo = self.playlist.proximo.anterior.anterior
        self.output.stop()
        self.play()
    ...
    def sonarAntes(self, s):
        if self.playlist != None:
            self.playlist.proximo = self.playlist.proximo.anterior
